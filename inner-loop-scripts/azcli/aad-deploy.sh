...
export K8S_RBAC_AAD_PROFILE_TENANTID=9a015b64-0784-4076-a505-0db87f1c9ead
export K8S_RBAC_AAD_PROFILE_TENANT_DOMAIN_NAME=togunderaad.onmicrosoft.com
...
echo Creating group add-to-bu0001a000800-cluster-admin
...
export K8S_RBAC_AAD_ADMIN_GROUP_OBJECTID=$(az ad group create --display-name add-to-bu0001a000800-cluster-admin --mail-nickname add-to-bu0001a000800-cluster-admin --query objectId -o tsv)
...
export AKS_ADMIN_OBJECTID=$(az ad user create --display-name=bu0001a0008-admin --user-principal-name bu0001a0008-admin@${K8S_RBAC_AAD_PROFILE_TENANT_DOMAIN_NAME} --force-change-password-next-login --password bu0001a0008Admin --query objectId -o tsv)
